...
# run runs test
# H0 is that time series is random
# if p value is large, then we accept that series is random
# if p value is small we reject H0 and conclude that the series is  NOT random
